...
void show( const Racional& r) {
    if( r.getNumerador()==r.getDenominador() ) { cout << 1; return; }
    if( r.getNumerador()==0 ) { cout << 0; return; }
    if( r.getDenominador()==1 ) {cout << r.getNumerador(); return;}
...
int main(int argc, char** argv) {
    ...
    // Salida por consola
    cout << " a es "; show(a); cout<<endl;
    cout << " b es "; show(b); cout<<endl;
    cout << " suma es "; show(suma); cout<<endl;
    cout << " resta es "; show(resta); cout<<endl;
    cout << " multip es "; show(multip); cout<<endl;
    cout << " divid es "; show(divid); cout<<endl;
    cout << " suma2 es "; show(suma2); cout<<endl;
    cout << " resta2 es "; show(resta2); cout<<endl;
    cout << " multip2 es "; show(multip2); cout<<endl;
    cout << " divid2 es "; show(divid2); cout<<endl;
