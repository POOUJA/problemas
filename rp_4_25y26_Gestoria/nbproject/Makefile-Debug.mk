...
${OBJECTDIR}/EmpleadoComision.o: EmpleadoComision.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpleadoComision.o EmpleadoComision.cpp

${OBJECTDIR}/EmpleadoHoras.o: EmpleadoHoras.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpleadoHoras.o EmpleadoHoras.cpp

${OBJECTDIR}/EmpleadoNoExiste.o: EmpleadoNoExiste.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpleadoNoExiste.o EmpleadoNoExiste.cpp

${OBJECTDIR}/EmpleadoSFijo.o: EmpleadoSFijo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpleadoSFijo.o EmpleadoSFijo.cpp
...
${OBJECTDIR}/EmpresaNoExiste.o: EmpresaNoExiste.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmpresaNoExiste.o EmpresaNoExiste.cpp

${OBJECTDIR}/Gestoria.o: Gestoria.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gestoria.o Gestoria.cpp

${OBJECTDIR}/ItemDuplicable.o: ItemDuplicable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ItemDuplicable.o ItemDuplicable.cpp

${OBJECTDIR}/ItemNombre.o: ItemNombre.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ItemNombre.o ItemNombre.cpp
